...
function scrollTo(position){
	...
	//start script DEMO
		...
		$.each(AllWords, function (index, value) {
            ...
            if (value.Mod == "2") { 
				count=count+1;
				num++;
				//console.log("AllWords[" + count + "] = {Word:'" + this.Word + "', Num:" + num + ", Example:'" + this.Example + "', Definition:'" + this.Definition + "', GreekDef:'" + this.GreekDef + "', Deriv:'" + this.Deriv + "', File:'" + this.File + "', ExFile:'" + this.ExFile + "', KindOf:'" + this.KindOf + "', Mod:'" + this.Mod + "', Lesson:'" + this.Lesson + "'};") 
				console.log("AllWords[" + count + "] = {Word:" + this.Word + ", Num:" + num + ", Example:" + this.Example + ", Definition:" + this.Definition + ", GreekDef:" + this.GreekDef + ", Deriv:" + this.Deriv + ", File:" + this.File + ", ExFile:" + this.ExFile + ", KindOf:" + this.KindOf + ", Mod:" + this.Mod + ", Lesson:" + this.Lesson + "};") 
			}
	...
	if (AllWords[0].Opposite != null) { $("<div class=\"Opposite\"><div>Opposites</div><div></div></div>").insertAfter(".glexExample"); }
...
$(".glossaryName").css('font-size', '45px');
$(".glossaryDefinition,.Deriv>div:last-child,.showgreekDef,.glossaryExample,.Opposite>div:last-child,glossaryTitle,.selectMods").css('font-size', '28px');
...
function LessonOrder(a){
	...
	//var order=["Cover page","Lesson A","Lesson A (WB)","Lesson B","Lesson B (WB)","Lesson C","Lesson C (WB)","Lesson D","Lesson D (WB)","Lesson E","Lesson E (WB)","Round-up","Round-up (WB)","Culture page","CLIL","Song","Think it through","Think it through (WB)"];
	var order=["Cover page","A","A (WB)","B","B (WB)","C","C (WB)","D","D (WB)","E","E (WB)","Round-up","Round-up (WB)","Culture page","CLIL","Song","Think it through"];
	var returnvar=0;
